...
public class InitialValueCheckBox extends AppCompatCheckBox {
    private static final String EXTRA_SUPER_STATE = "com.example.mainapp.cardform.view.InitialValueCheckBox.EXTRA_SUPER_STATE";
    private static final String EXTRA_CHECKED_VALUE = "com.example.mainapp.cardform.view.InitialValueCheckBox.EXTRA_CHECKED_VALUE";
