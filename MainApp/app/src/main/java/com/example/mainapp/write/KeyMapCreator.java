...
import com.example.mainapp.write.Common.Preference;
...
//                }
                ...
                // Set key files.
                int numberOfLoadedKeys = reader.setKeyFile(Common.mAppContext);
...
//                        WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
                ...
                if (!reader.setMappingRange(
                    ...
                    // Error.
                    Toast.makeText(Common.mAppContext,
...
//                mCreateKeyMap.setEnabled(false);
                ...
                Toast.makeText(Common.mAppContext, R.string.info_mapping_no_keyfile_found, Toast.LENGTH_LONG).show();
            }
        }
        else{
            Toast.makeText(Common.mAppContext, R.string.info_mapping_no_keyfile_selected, Toast.LENGTH_LONG).show();
        }
        int a = 2;
    }
...
//                    mCancel.setEnabled(true);
    ...
    private void keyMapCreated(MCReader reader) {
        ...
        if (reader.getKeyMap().size() == 0) {
            ...
            Toast.makeText(Common.mAppContext, R.string.info_no_key_found,
                    Toast.LENGTH_LONG).show();
        } else {
